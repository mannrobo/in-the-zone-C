...
#pragma config(Motor,  port6,           rubberbands,   tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port9,           rightCone,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          leftCone,      tmotorVex393_HBridge, openLoop, reversed)
...
void lift(int clockwise, int counterClockwise) {
		int speed = 30;
		if(clockwise == 1) {
			 speed++;
